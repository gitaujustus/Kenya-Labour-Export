  ...
  return (
    <div className='min-h-[90vh] py-10 bg-slate-50 flex items-center'>
      <form action={createCitizenAccount} className='w-[95vw] sm:w-[70vw] md:w-[50vw] lg:w-[30vw] mx-4 sm:mx-auto  text-gray-800 bg-white shadow-md border-t-4 border-teal-700 px-5 md:px-10 py-8 rounded-lg'>
        ...
        <div className='mt-5'>
          <label htmlFor="countryName" className='flex gap-2'>Country Name <span><CgAsterisk color='red' size={12} /></span></label>
          <input type="text" name='countryName' id="countryName" className='border outline-teal-200 px-3 py-2 mt-2 rounded-md w-full focus:outline-teal-700' />
        </div>
        <div className="my-5">
